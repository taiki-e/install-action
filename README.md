...
| [**trunk**](https://github.com/thedodd/trunk) | `$CARGO_HOME/bin` | [GitHub Releases](https://github.com/thedodd/trunk/releases) | Linux, macOS, Windows | [Apache 2.0 OR MIT](https://github.com/thedodd/trunk/blob/master/LICENSE-MIT) |
